...
1. **CORE-EEAT Quick Score** — Estimate all 8 dimensions, prioritize red/yellow areas, and hand off to [content-quality-auditor](../content-quality-auditor/SKILL.md) for full scoring when needed.
...
- A page is decayed enough that a rewrite may beat a refresh (e.g., outdated premise, intent shift, or >50% of content stale) — state the finding and ask: (1) refresh in place, or (2) rewrite as new content via [seo-content-writer](../seo-content-writer/SKILL.md).
...
- A request to "refresh" content that is actually net-new (no existing URL) — note the mismatch once and route to [seo-content-writer](../seo-content-writer/SKILL.md) rather than fabricating a prior version.
...
Primary: [content-quality-auditor](../content-quality-auditor/SKILL.md) — re-score refreshed content before shipping.
