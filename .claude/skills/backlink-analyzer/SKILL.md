...
- **Primary next skill**: [domain-authority-auditor](../domain-authority-auditor/SKILL.md) when toxicity or authority concerns need formal scoring.
...
Toxic ratio > 15% → [domain-authority-auditor](../domain-authority-auditor/SKILL.md). Otherwise → Terminal. Visited-set rule applies per [skill-contract.md](../../../references/skill-contract.md).
