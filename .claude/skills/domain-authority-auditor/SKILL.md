...
CAUTIOUS + link-quality: [backlink-analyzer](../backlink-analyzer/SKILL.md). UNTRUSTED: [entity-optimizer](../entity-optimizer/SKILL.md). TRUSTED: terminal. Visited-set rule applies per [skill-contract.md](../../../references/skill-contract.md).
